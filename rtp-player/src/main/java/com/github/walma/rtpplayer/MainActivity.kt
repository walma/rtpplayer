...
private fun RtpPlayerContent(
    ...
    Box(
            ...
            Column(
                ...
                if (playerState.isPlaying || playerState.isBuffering) {
                    ...
                    Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                        ...
                        Button(onClick = onRecord, colors = ButtonDefaults.buttonColors(containerColor = Color(0xFFB71C1C))) {
                            Text("REC")
                        }
                    }
                }
        ...
        if (showSettingsDialog) {
            SettingsDialog(
                streamUri = streamUri, onStreamUriChange = onStreamUriChange,
                networkCaching = networkCaching, onNetworkCachingChange = onNetworkCachingChange,
                clockJitter = clockJitter, onClockJitterChange = onClockJitterChange,
                clockSynchro = clockSynchro, onClockSynchroChange = onClockSynchroChange,
                selectedDemux = selectedDemux, onDemuxChange = onDemuxChange,
...
private fun SettingsDialog(
    streamUri: String, onStreamUriChange: (String) -> Unit,
    networkCaching: String, onNetworkCachingChange: (String) -> Unit,
    clockJitter: String, onClockJitterChange: (String) -> Unit,
    clockSynchro: String, onClockSynchroChange: (String) -> Unit,
    selectedDemux: String, onDemuxChange: (String) -> Unit,
    onDismiss: () -> Unit
) {
        ...
        Card(modifier = Modifier.fillMaxWidth().padding(16.dp), shape = MaterialTheme.shapes.large) {
            Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                ExposedDropdownMenuBox(expanded = expanded, onExpandedChange = { expanded = !expanded }) {
                    OutlinedTextField(
                        value = selectedDemux, onValueChange = {}, readOnly = true,
                        label = { Text("Demuxer") }, trailingIcon = { ExposedDropdownMenuDefaults.TrailingIcon(expanded) },
